...
/**
 * Strings for component 'auth_shibboleth', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
...
$string['auth_shib_auth_method_description'] = '給Shibboleth認證方法起一個使用者熟悉的姓名。可以是您的Shibboleth組織的姓名，比如<tt>SWITCHaai Login</tt> 或者 <tt>InCommon Login</tt> 或者其他類似的姓名。';
...
$string['auth_shib_idp_list_description'] = '提供身份提供者的entityID列表，提供使用者在登入頁面選擇。<br />每行都必須是一半逗號分隔的二元組，一個是idP（在Shibboleth metadata檔案中)的entityID，另一個是顯示在下拉列表中的ldP的姓名。<br />如果您的Moodle是多個同盟伺服器安裝的一部份，那麼會使用可選擇的第三個參數，那是Shibboleth工作階段初始器的位置。';
...
$string['auth_shib_no_organizations_warning'] = '如果您欲使用整合的WAYF服務，您必須提供實體提供者entityIDs的清單(以逗號區隔，他們的姓名和連線建立者）';
