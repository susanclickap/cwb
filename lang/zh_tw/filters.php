...
/**
 * Strings for component 'filters', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   filters
...
$string['courserolelabel'] = '課程類別：{$a->categoryname} 課程名稱：{$a->coursename} 角色名：{$a->rolename} 姓名：{$a->label}';
