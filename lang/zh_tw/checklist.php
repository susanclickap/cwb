...
$string['autoupdate_help'] = '當您完成課程中的相關活動後會自動勾選清單上的項目<br />
如果對活動開啟了完成追踪的設定，系統會用記號勾劃清單上的項目。<br>
每個活動的完成方式都不一樣 - 例如\'檢視\' 資源、 \'完成\' 一個測驗或作業、 \'發表\' 一篇文章到討論區或參與聊天等。(如果想了解標記成 \'完成\' 的原因, 請詢問您的網站管理員查看檔案 \'mod/checklist/autoupdate.php\')<br />';
...
$string['autoupdatewarning_teacher'] = '此清單項目的自動更新已設為開啟（當學生完成相關活動後）。';
