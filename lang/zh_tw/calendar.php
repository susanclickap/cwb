...
/**
 * Strings for component 'calendar', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   calendar
...
$string['calendarpreferences'] = '行事曆偏好設定';
...
$string['errorrruleday'] = '這規則包含無效的日期參數';
$string['errorrrulefreq'] = '這規則包含無效的頻率參數';
...
$string['hidecourseevents'] = '隱藏課程事件';
$string['hideglobalevents'] = '隱藏全網站事件';
$string['hidegroupsevents'] = '隱藏群組事件';
$string['hideuserevents'] = '隱藏用戶事件';
$string['hourly'] = '每小時的';
$string['ical'] = 'iCal';
...
$string['repeatedevents'] = '重複事件';
$string['repeateditall'] = '也套用到在此系列事件中的其他{$a}個事件';
$string['repeateditthis'] = '只變更這個事件';
$string['repeatevent'] = '重複此事件';
$string['repeatnone'] = '不重複';
$string['repeatweeksl'] = '每週重複，總共幾次?';
$string['repeatweeksr'] = '事件';
$string['sat'] = '六';
$string['saturday'] = '星期六';
$string['showcourseevents'] = '顯示課程事件';
$string['showglobalevents'] = '顯示整個網站事件';
$string['showgroupsevents'] = '顯示群組事件';
$string['shown'] = '顯示';
$string['showuserevents'] = '顯示用戶事件';
