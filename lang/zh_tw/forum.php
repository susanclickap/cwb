...
/**
 * Strings for component 'forum', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   forum
...
$string['editing'] = '編輯中';
$string['emaildigest_0'] = '您將每一討論區貼文收到一封email';
$string['emaildigest_1'] = '您將每天收到一封貼文摘要的email，它包含每一討論區貼文的完整內容';
$string['emaildigest_2'] = '您將每天收到一封貼文摘要的email，它只包含每一討論區貼文的主旨';
...
$string['emaildigestupdated'] = '這郵寄貼文摘要的選項，已經為討論區 \'{$a->forum}\'被更改為 \'{$a->maildigesttitle}\' 。 {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = '在您個人資料表的\'{$a->maildigesttitle}\'預設設定，將被用於 \'{$a->forum}\'討論區。 {$a->maildigestdescription}.';
...
$string['maxattachmentsize_help'] = '<p>附件的檔案大小是可以加以限制的，教師可以在建立討論區時設定它。</p>　　
<p>有時，您可以提交一個比這個容量還大的檔案，但這個檔案不會被保存下來，且您會看到一個錯誤資訊。</p>';
...
$string['namenews'] = '公佈欄';
$string['namenews_help'] = '公佈欄是在建立一課程時自動產生的，用於向學生公告訊息。一個課程只能有一個公佈欄，只有教師和管理員可以在這裡貼文。"最新消息"區塊將顯示公佈欄中的最新消息。';
...
$string['reply_handler'] = '經由email回應討論區的貼文';
$string['reply_handler_name'] = '回應討論區的貼文';
...
$string['subscribersto'] = '"{$a->name}"的訂閱者';
...
$string['trackingtype_help'] = '若啟用，參與者可以在討論區和在在議題中追蹤已閱讀和未閱讀的貼文。

共有三種選擇：

*自行選用--參與者可以經由管理區塊裡的一個連結，將追蹤功能開啟或關閉。
