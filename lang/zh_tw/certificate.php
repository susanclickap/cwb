...
$string['customtext_help'] = '如果您想在證書上列印其他教師的姓名，除了線條圖像外，請不要選擇「列印教師」或任何個簽名圖像。在此文本框中輸入您想出現的教師姓名。在預設設定中，此文字將會位於證書的左下方。 可使用以下的HTML 標纖：<br>, <p>, <b>, <i>, <u>, <img> (src 及闊度(或高度) 是強制性的), <a> (href 是強制性的), <font> (屬性包括: 顏色, (hex 顏色代號), 字型, (arial, times, courier, helvetica, symbol)).';
$string['date'] = '在';
$string['datefmt'] = '日期格式';
