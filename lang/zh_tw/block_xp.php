...
/**
 * Strings for component 'block_xp', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   block_xp
...
$string['defaultsettings'] = '默認設置';
$string['defaultvisuals'] = '默認的視覺效果';
...
$string['promointro'] = '這是_升級_！_插件！充分發揮其潛力！';
...
$string['reverttopluginsdefaults'] = '恢復為插件默認值';
$string['reverttopluginsdefaultsintro'] = '如果你希望恢復為插件默認值，請接下面的按扭';
$string['reward'] = '獎勵';
$string['rule'] = '規則';
$string['rulecm'] = '活動或資源';
...
$string['wherearexpused_desc'] = '當你設定為"在課程中"，獲得的經驗值將只會用在有添加區塊的課程中。若你設定為"在整個網站上"，則用戶將會在網站升級，使用他在整個網站上所獲得的經驗值，而不是限制在選定的單一課程上。';
$string['whoops'] = '哎呦！';
$string['xp'] = '經驗值';
