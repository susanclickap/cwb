...
$string['pseudofirstname'] = '學生偽姓名';
$string['pseudofirstname_desc'] = '<b>[自訂]</b><br />在Turnitin檔案檢視器中顯示的學生姓名';
$string['pseudolastname'] = '學生偽行代';
$string['pseudolastname_desc'] = '<b>[自訂]</b><br />在Turnitin檔案檢視器中顯示的學生行代';
$string['pseudolastnamegen'] = '自動生成行代';
$string['pseudolastnamegen_desc'] = '如果設定為是，學生偽行代會設定在用戶檔案欄中，此欄繼會自動填充獨特的標識符。';
