...
$string['canntenrol'] = '免簽核選課已被關閉或過期';
$string['cohortnonmemberinfo'] = '只有指定人員類別\'{$a}\'的成員可以免簽核選課';
$string['cohortonly'] = '只有指定人員類別成員';
$string['cohortonly_help'] = '教師可以限制為只有指定的指定人員類別的成員才免簽核選課。注意，改變這一設定對於已經選課的用戶沒有影響。';
...
$string['defaultrole_desc'] = '選擇當用戶免簽核選課時，被指派的角色';
...
$string['expirymessageenrolledsubject'] = '免簽核選課過期通知';
$string['expirymessageenrollerbody'] = '在\'{$a->course}\' 課程的免簽核選課將會在下{$a->threshold} 過期，受影響的用戶有：

{$a->users}

要延長他們的選課，請到{$a->extendurl}';
$string['expirymessageenrollersubject'] = '免簽核選課過期通知';
...
$string['maxenrolled_help'] = '指定可以免簽核選課的最大用戶數目。0表示無限制。';
$string['maxenrolledreached'] = '已經達到免簽核選課用戶數目的上限。';
$string['messageprovider:expiry_notification'] = '免簽核選課通知';
...
$string['pluginname'] = '免簽核選課';
$string['pluginname_desc'] = '透過免簽核選課外掛，用戶可以自己選擇想參加的課程。可以透過選課密碼保護課程。選課過程是透過人工選課外掛完成的，所以必須在課程中啟用這個外掛套件。';
$string['requirepassword'] = '必須設定選課密碼';
$string['requirepassword_desc'] = '在新課程必須設定選課密碼，而現有課程不能移除選課密碼。';
$string['role'] = '預設的被分配的角色';
$string['waiting:config'] = '配置免簽核選課外掛套件';
...
$string['status_desc'] = '在新課程啟用免簽核選課方式';
$string['status_help'] = '若關閉，所有的免簽核選課者會被停學，且新用戶無法選課。';
...
即日起即可登入平台，進入課程開始學習:
  ...
  {$a->courseurl}';
$string['institutiononly'] = '只有指定稱職成員';
$string['departmentonly'] = '只有指定科室成員';
$string['institutionnonmemberinfo'] = '只有指定稱職\'{$a}\'的成員可以免簽核選課.';
$string['departmentnonmemberinfo'] = '只有指定科室\'{$a}\'的成員可以免簽核選課.';
$string['unenrolenddate'] = '退選結束日期';
$string['unenrolenddate_help'] = '允許使用者課程退選的結束日期.';
$string['waitingenrol'] = '報名後補';
$string['waitingenrolconfirm'] = '您確定要從"{$a->coursename}"課程中等待後補？<br>已後補人數 : {$a->waitingcount}';
$string['notification_waiting'] = '等待後補中';
$string['notification_unenroldateexpired'] = '退選截止日期為 {$a}';
$string['enrolenddaterror2'] = '選課的結束日期不可以晚於課程結束日期。';
