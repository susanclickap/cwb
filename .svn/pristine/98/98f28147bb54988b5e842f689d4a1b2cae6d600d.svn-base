...
/**
 * Strings for component 'bigbluebuttonbn', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
...
$string['config_scheduled_duration_compensation'] = '補償時間(分鐘)';
...
$string['config_server_url'] = 'BigBlueButton 伺服器網址';
...
$string['event_recording_published'] = '錄影已發佈';
$string['event_recording_unpublished'] = '錄影未發佈';
...
$string['mod_form_block_schedule'] = '活動時程';
$string['mod_form_field_closingtime'] = '已停止加入';
$string['mod_form_field_conference_name'] = '會議名稱';
$string['mod_form_field_duration'] = '時間長短';
...
$string['mod_form_field_voicebridge_help'] = '';
...
$string['modulenameplural'] = '視訊會議';
$string['pluginadministration'] = '視訊會議管理';
$string['pluginname'] = '視訊會議';
$string['serverhost'] = '伺服器名稱';
$string['started_at'] = '已經開始';
$string['starts_at'] = '開始';
$string['view_conference_action_end'] = '結束議程';
$string['view_conference_action_join'] = '加入議程';
...
$string['view_recording'] = '錄製';
$string['view_recording_actionbar'] = '工具';
