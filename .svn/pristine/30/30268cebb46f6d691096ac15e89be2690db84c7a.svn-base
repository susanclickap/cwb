...
/**
 * Strings for component 'attendance', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   attendance
...
$string['attendance_already_submitted'] = '你不可以自己登記出席，它已經全部設定好了。';
...
$string['myvariables'] = '我的變數';
$string['newdate'] = '新日期';
$string['newduration'] = '新上課期間';
$string['newstatusset'] = '新的狀態集';
...
$string['nosessiondayselected'] = '未選出上課日';
...
$string['restoredefaults'] = '還原為預設';
$string['resultsperpage'] = '每頁結果';
...
$string['studentscanmark_help'] = '如果勾選，學生將可以更改他們自己在這一上課時段的出缺席狀態。';
