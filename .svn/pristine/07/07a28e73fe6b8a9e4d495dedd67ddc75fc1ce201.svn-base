...
/**
 * Strings for component 'tool_userrestore', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
...
$string['promo'] = 'moodle 的用戶復原插件';
$string['promodesc'] = '此一插件是由 Sebsoft 網站託管和軟體發展公司所撰寫
