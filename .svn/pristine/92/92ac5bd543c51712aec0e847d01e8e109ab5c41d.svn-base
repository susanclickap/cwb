...
/**
 * Strings for component 'moodle', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   moodle
...
$string['cookiesenabled_help'] = '<p align="center"><b>Cookies</b></p><p>本站使用了兩個cookie。</p><p>最重要的是連線cookie，通常叫做<b>MoodleSession</b>。您必須在瀏覽器裡允許這個cookie，以便使您的登入在頁與頁之間連續有效。當您登離或關閉瀏覽器，這個cookie在瀏覽器和伺服器裡都會被刪除。</p><p>另一個cookie純粹是為了方便，通常被叫做類似<b>MOODLEID</b>之類的姓名。它只用來在瀏覽器裡記住您的用戶名。這意味著當您再次回到本站，登入頁面裡的用戶名已經替您填好了。拒絕此cookie是安全的，只不過每次登入都要重新輸入用戶名而已。</p>';
...
* 摘要(完整貼文) -- 你每天只會收到一封email，它會包含每一篇貼文的全部內容；
...
$string['firstname'] = '姓名';
$string['firstnamephonetic'] = '第一個姓名 --  拼音';
...
$string['messagedselectedcountusersfailed'] = '發生問題，且{$a}簡訊沒有被送出';
$string['messagedselecteduserfailed'] = '這簡訊沒有傳送給用戶{$a->fullname}';
$string['messagedselectedusers'] = '訊息已經發送給選出的用戶，而收件人列表已重設了。';
...
$string['missingfirstname'] = '缺少姓名資料';
$string['missingfromdisk'] = '從磁碟遺失';
$string['missingfullname'] = '缺少完整名稱';
$string['missinglastname'] = '缺少行代資料';
...
$string['textediting_help'] = '若你選擇一個HTML編輯器，比如 Atto 或 TinyMCE ，文字輸入區的上面會出現有按鈕的工具列，以方便撰寫內容。
...
$string['time'] = '時間';
$string['timecreatedcourse'] = '已建立課程時間';
$string['timezone'] = '時區';
$string['to'] = '到';
