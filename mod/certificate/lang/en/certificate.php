...
$string['dateformat_xiyuan'] = 'Xiyuan';
$string['dateformat_china'] = 'China';

$string['requiredcompletionnotmet'] = 'You must completion condition in the course before you can access this certificate';
$string['requiredcompletion'] = 'Completion requirements';
$string['requiredcompletion_help'] = 'Required to completion condition in course.';

$string['strftimedate'] = '中 華 民 國 {$a->y} 年 {$a->m} 月 {$a->d} 日';
$string['strftimedate2'] = '西 元 {$a->y} 年 {$a->m} 月 {$a->d} 日';
